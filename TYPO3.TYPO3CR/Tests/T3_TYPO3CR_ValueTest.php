 ...
 */
class T3_TYPO3CR_ValueTest extends T3_Testing_BaseTestCase {
	...
	public function typeAssignmentWorks() {
		...
		$value = new T3_TYPO3CR_Value('test');
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::UNDEFINED, 'New Value object was not of type UNDEFINED, although expected.');

		$value = new T3_TYPO3CR_Value('test', T3_phpCR_PropertyType::UNDEFINED);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::UNDEFINED, 'New Value object was not of type UNDEFINED, although requested.');

		$value = new T3_TYPO3CR_Value('test', T3_phpCR_PropertyType::STRING);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::STRING, 'New Value object was not of type STRING, although requested.');

		$value = new T3_TYPO3CR_Value('test', T3_phpCR_PropertyType::BINARY);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::BINARY, 'New Value object was not of type BINARY, although requested.');

		$value = new T3_TYPO3CR_Value(10, T3_phpCR_PropertyType::LONG);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::LONG, 'New Value object was not of type LONG, although requested.');

		$value = new T3_TYPO3CR_Value(1.5, T3_phpCR_PropertyType::DOUBLE);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::DOUBLE, 'New Value object was not of type DOUBLE, although requested.');

		$value = new T3_TYPO3CR_Value('2007-09-22', T3_phpCR_PropertyType::DATE);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::DATE, 'New Value object was not of type DATE, although requested.');

		$value = new T3_TYPO3CR_Value(TRUE, T3_phpCR_PropertyType::BOOLEAN);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::BOOLEAN, 'New Value object was not of type BOOLEAN, although requested.');

		$value = new T3_TYPO3CR_Value('name', T3_phpCR_PropertyType::NAME);
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::NAME, 'New Value object was not of type NAME, although requested.');
		...
		$this->assertEquals($value->getType(), T3_phpCR_PropertyType::URI, 'New Value object was not of type URI, although requested.');
	...
	public function getStringWorksOnStringValue() {
		$value = new T3_TYPO3CR_Value('123.5 test', T3_phpCR_PropertyType::STRING);
	...
	public function getStringWorksOnDateValue() {
		$value = new T3_TYPO3CR_Value('2007-08-31T16:47+00:00', T3_phpCR_PropertyType::DATE);
	...
	public function getBooleanWorksOnStringValue() {
		...
		$value = new T3_TYPO3CR_Value('0', T3_phpCR_PropertyType::STRING);
