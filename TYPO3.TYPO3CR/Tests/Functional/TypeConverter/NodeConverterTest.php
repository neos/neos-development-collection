...
class NodeConverterTest extends FunctionalTestCase {
	...
	protected function setupNodeWithShadowNodeInPersonalWorkspace() {
		...
		$germanContext = $this->contextFactory->create(array('workspaceName' => $this->currentTestWorkspaceName, 'dimensions' => array('locales' => array('de_DE', 'mul_ZZ'))));
	...
	public function nodeFromGermanDimensionIsFetchedCorrectly() {
		...
		$headlineNode = $this->convert('/headline@' . $this->currentTestWorkspaceName . ';locales=de_DE');
