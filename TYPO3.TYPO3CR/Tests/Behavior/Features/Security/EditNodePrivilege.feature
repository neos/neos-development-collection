Feature: Privilege to restrict editing of nodes
  ...
  Background:
      ...
      privilegeTargets:
        ...
        'Neos\ContentRepository\Security\Authorization\Privilege\Node\EditNodePrivilege':
          ...
          'Neos.ContentRepository:EditServiceNodes':
            matcher: 'isDescendantNodeOf("/sites/typo3cr/service") && nodeIsOfType("Neos.ContentRepository.Testing:Document")'
    ...
    And I have the following nodes:
      ...
      | 11d3aded-fb1a-70e7-1412-0b465b11fcd8 | /sites/typo3cr/events       | Neos.ContentRepository.Testing:Document | {"title": "Events", "description": "Some cool event"}  | live      |
