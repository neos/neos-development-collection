Feature: Remove node
  ...
  Background:
    Given I have the following nodes:
      ...
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3               | TYPO3.Neos.NodeTypes:Page | {"title": "Home"}    |
      | 68ca0dcd-2afb-ef0e-1106-a5301e65b8a0 | /sites/neosdemotypo3/company       | TYPO3.Neos.NodeTypes:Page | {"title": "Company"} |
      | 52540602-b417-11e3-9358-14109fd7a2dd | /sites/neosdemotypo3/company/about | TYPO3.Neos.NodeTypes:Page | {"title": "About"}   |
  ...
  Scenario: Remove a node in user workspace and publish removes the node itself
    ...
    And I get a node by path "/sites/neosdemotypo3/company" with the following context:
      | Workspace |
      | live      |
