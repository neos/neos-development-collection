Feature: Matching most specific locale
  In order to have translated content with flexible fallback rules
  As an API user of the content repository
  I need a way to retrieve nodes matching an ordered list of locales
  ...
  @fixtures
  Scenario: One document node and specific locales
    Given I have the following nodes:
  ...
  @fixtures
  Scenario: One document node and fallback from specific locale to locale in list of locales
    Given I have the following nodes:
      | Identifier                           | Path                         | Node Type                 | Properties              | Locale |
    ...
    When I get a node by path "/sites/neosdemotypo3/subpage" with the following context:
      ...
      | de_DE, de_ZZ, mul_ZZ |
    Then I should have one node
    And The node locales dimension should be "de_ZZ"

  @fixtures
  Scenario: One document node and fallback to most specific locale in list of locales
    Given I have the following nodes:
      | Identifier                           | Path                         | Node Type                 | Properties                 | Locale |
    ...
    When I get a node by path "/sites/neosdemotypo3/subpage" with the following context:
      ...
      | en_UK, en_US, en_ZZ |
    Then I should have one node
    And The node locales dimension should be "en_UK"
    When I get a node by path "/sites/neosdemotypo3/subpage" with the following context:
      | Locales             |
      | en_US, en_UK, en_ZZ |
    Then I should have one node
    And The node locales dimension should be "en_US"

  @fixtures
  Scenario: Multiple child nodes and specific locales
    Given I have the following nodes:
      | Identifier                           | Path                                 | Node Type                     | Properties                 | Locale |
  ...
  @fixtures
  Scenario: Multiple child nodes and fallback from specific locale to locale in list of locales
    Given I have the following nodes:
      | Identifier                           | Path                                 | Node Type                     | Properties                 | Locale |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage         | TYPO3.Neos.NodeTypes:Page     | {"title": "International"} | mul_ZZ |
  ...
  @fixtures
  Scenario: Multiple child nodes and fallback to most specific locale in list of locales
    Given I have the following nodes:
      | Identifier                           | Path                                 | Node Type                     | Properties                        | Locale |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage         | TYPO3.Neos.NodeTypes:Page     | {"title": "International"}        | mul_ZZ |
      | ecf40ad1-3119-0a43-d02e-55f8b5aa3c70 | /sites/neosdemotypo3/subpage/main/c1 | TYPO3.Neos.NodeTypes:Headline | {"title": "First"}                | en_ZZ  |
  ...
  @fixtures
  Scenario: Multiple nodes on path and specific locales
    Given I have the following nodes:
      | Identifier                           | Path                                                         | Node Type                 | Properties                       | Locale |
  ...
  @fixtures
  Scenario: Multiple nodes on path and fallback to most specific locale in list of locales
    Given I have the following nodes:
      | Identifier                           | Path                                                         | Node Type                 | Properties                            | Locale |
  ...
  @fixtures
  Scenario: One document node and specific locales by identifier
    Given I have the following nodes:
      | Identifier                           | Path                         | Node Type                 | Properties              | Locale |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "Subpage"}    | en_US  |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "Unterseite"} | de_DE  |
  ...
  @fixtures
  Scenario: One document node and fallback from specific locale to locale in list of locales by identifier
    Given I have the following nodes:
      | Identifier                           | Path                         | Node Type                 | Properties              | Locale |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "Subpage"}    | en_ZZ  |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "Unterseite"} | de_ZZ  |
  ...
  @fixtures
  Scenario: One document node and fallback to most specific locale in list of locales by identifier
    Given I have the following nodes:
      | Identifier                           | Path                         | Node Type                 | Properties                 | Locale |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "International"} | en_ZZ  |
      | fd5ba6e1-4313-b145-1004-dad2f1173a35 | /sites/neosdemotypo3/subpage | TYPO3.Neos.NodeTypes:Page | {"title": "US"}            | en_US  |
