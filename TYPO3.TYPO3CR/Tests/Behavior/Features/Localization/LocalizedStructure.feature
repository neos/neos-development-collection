Feature: Localizated structure
  ...
  @fixtures
  Scenario: The same node can be fetched using different node paths in different locales
    Given I have the following nodes:
  ...
  @fixtures
  Scenario: Child nodes can be fetched using different node paths in different locales
    Given I have the following nodes:
      | Identifier                           | Path                                 | Node Type                 | Properties              | Locale |
