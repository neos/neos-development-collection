...
class Version20110920104739 extends AbstractMigration {
	...
	public function down(Schema $schema) {
		...
		$this->addSql("CREATE TABLE typo3_typo3cr_domain_model_contenttype (flow3_persistence_identifier VARCHAR(40) NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(flow3_persistence_identifier)) ENGINE = InnoDB");
