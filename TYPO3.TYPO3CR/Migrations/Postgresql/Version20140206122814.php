...
class Version20140206122814 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER TABLE typo3_typo3cr_domain_model_nodedata ADD dimensionshash VARCHAR(32) NOT NULL");
		$this->addSql("ALTER TABLE typo3_typo3cr_domain_model_nodedata ADD dimensionvalues BYTEA NOT NULL");
