...
/**
 * Adjust some leftover things relasted to TYPO3CR schema
 */
class Version20160223103919 extends AbstractMigration {
	...
	public function up(Schema $schema) {
		...
		$this->addSql("ALTER INDEX idx_71de9cfba762b951 RENAME TO IDX_71DE9CFBBB46155");
	}
	...
	public function down(Schema $schema) {
		...
		$this->addSql("ALTER INDEX idx_71de9cfbbb46155 RENAME TO idx_71de9cfba762b951");
