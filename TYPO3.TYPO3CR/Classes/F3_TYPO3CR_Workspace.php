...
class F3_TYPO3CR_Workspace implements F3_PHPCR_WorkspaceInterface {
	 ...
	 *
	 * @return F3_TYPO3CR_Session a Session object
	 * @author Karsten Dambekalns <karsten@typo3.org>
	 */
	...
	public function copy($srcAbsPath, $destAbsPath, $srcWorkspace = NULL) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406774);
	}
	...
	public function klone($srcWorkspace, $srcAbsPath, $destAbsPath, $removeExisting) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406775);
	}
	...
	public function move($srcAbsPath, $destAbsPath) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406776);
	}
	...
	public function restore(array $versions, $removeExisting) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406777);
	}
	...
	public function getNamespaceRegistry() {
		return $this->componentFactory->getComponent('F3_PHPCR_NamespaceRegistryInterface', $this->session->getStorageBackend(), $this->componentFactory);
	}
	...
	public function getNodeTypeManager() {
		return $this->componentFactory->getComponent('F3_PHPCR_NodeType_NodeTypeManagerInterface', $this->session->getStorageBackend(), $this->componentFactory);
	}
	...
	public function getObservationManager() {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406780);
	}
	...
	public function getAccessibleWorkspaceNames() {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406781);
	}
	...
	public function getImportContentHandler($parentAbsPath, $uuidBehavior) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406782);
	}
	...
	public function createWorkspace($name, $srcWorkspace = NULL) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406783);
	}
	...
	public function deleteWorkspace($name) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406784);
	}
	...
	public function createActivity($title) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406785);
	}
	...
	public function merge(F3_PHPCR_NodeInterface $activityNode) {
		throw new F3_PHPCR_UnsupportedRepositoryOperationException('Method not yet implemented, sorry!', 1212406786);
	}
