...
class Repository implements \F3\PHPCR\RepositoryInterface {
	...
	protected $standardDescriptors = array(
		...
		self::OPTION_ADVANCED_VERSIONING_SUPPORTED => FALSE,
		...
		self::OPTION_NODETYPE_MANAGEMENT_SUPPORTED => TRUE,
		self::NODETYPE_MANAGEMENT_INHERITANCE => self::NODETYPE_MANAGEMENT_INHERITANCE_MINIMAL,
		self::NODETYPE_MANAGEMENT_OVERRIDES_SUPPORTED => FALSE,
		self::NODETYPE_MANAGEMENT_PRIMARY_ITEM_NAME_SUPPORTED => FALSE,
		self::NODETYPE_MANAGEMENT_ORDERABLE_CHILD_NODES_SUPPORTED => FALSE,
		self::NODETYPE_MANAGEMENT_RESIDUAL_DEFINITIONS_SUPPORTED => FALSE,
		self::NODETYPE_MANAGEMENT_AUTOCREATED_DEFINITIONS_SUPPORTED => FALSE,
		self::NODETYPE_MANAGEMENT_SAME_NAME_SIBLINGS_SUPPORTED => TRUE,
		self::NODETYPE_MANAGEMENT_PROPERTY_TYPES => array(),
		self::NODETYPE_MANAGEMENT_MULTIVALUED_PROPERTIES_SUPPORTED => TRUE,
