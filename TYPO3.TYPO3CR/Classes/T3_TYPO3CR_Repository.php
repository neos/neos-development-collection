...
class T3_TYPO3CR_Repository implements T3_phpCR_RepositoryInterface {
	 ...
	 * @throws T3_phpCR_NoSuchWorkspacexception
	...
	public function login($credentials = NULL, $workspaceName = 'default') {
		...
		$this->session = $this->componentManager->getComponent('T3_phpCR_SessionInterface', $workspaceName, $this, $this->storageAccess);
		return $this->session;
	}
