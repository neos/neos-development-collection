...
class PackageController extends \TYPO3\TYPO3\Controller\Module\StandardController {
	...
	public function deactivateAction($packageKey) {
		try {
			...
			$message = new \TYPO3\FLOW3\Error\Message('The package ' . $packageKey . ' is protected and can not be deactivated', 1343231679);
		}
	...
	public function activateAction($packageKey) {
		try {
			...
			$message = new \TYPO3\FLOW3\Error\Message('The package ' . $packageKey . ' is not present and can not be activated', 1343231681);
		}
		$this->flashMessageContainer->addMessage($message);
		$this->redirect('index');
	}
	...
	public function importAction($packageKey) {
		try {
			...
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231683);
		} catch (\TYPO3\FLOW3\Package\Exception\PackageRepositoryException $exception) {
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231684);
		}
		$this->flashMessageContainer->addMessage($message);
		$this->redirect('index');
	}
	...
	public function deleteAction($packageKey) {
		try {
			...
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231686);
		} catch (\TYPO3\FLOW3\Package\Exception\ProtectedPackageKeyException $exception) {
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231687);
		} catch (\TYPO3\FLOW3\Package\Exception $exception) {
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231688);
		}
		$this->flashMessageContainer->addMessage($message);
		$this->redirect('index');
	}
	...
	public function freezeAction($packageKey) {
		try {
			...
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231690);
		} catch (\TYPO3\FLOW3\Package\Exception\UnknownPackageException $exception) {
			$message = new \TYPO3\FLOW3\Error\Message($exception->getMessage(), 1343231691);
		}
		$this->flashMessageContainer->addMessage($message);
		$this->redirect('index');
	}
