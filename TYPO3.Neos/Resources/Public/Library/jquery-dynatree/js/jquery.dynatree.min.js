...
this.$dndMarker.css({"left":pos.left,/*was edited to adjust the marker to the fixed position of the pagetree container*/"top":pos.top-107,"z-index":1000}).show();}else{$target.removeClass("dynatree-drop-target");this.$dndMarker.hide();}
