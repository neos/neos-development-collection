define(["Library/jquery-with-dependencies", "Library/handlebars"], function(jQuery, Handlebars) {  var Ember = {exports: {}};  Ember.imports = {jQuery: jQuery, Handlebars: Handlebars};  Ember.lookup = { Ember: Ember, T3: window.T3};  window.Ember = Ember;// Version: v1.0.0-rc.3
