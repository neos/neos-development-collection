define(["Library/jquery-with-dependencies", "Library/handlebars", "Library/cldr"], function(jQuery, Handlebars, CLDR) {  CLDR.defaultLocale = window.T3Configuration.locale;  var Ember = {exports: {}};  var ENV = {LOG_VERSION: false};  Ember.imports = {jQuery: jQuery, Handlebars: Handlebars};  Ember.lookup = { Ember: Ember, T3: window.T3};  window.Ember = Ember;(function() {
