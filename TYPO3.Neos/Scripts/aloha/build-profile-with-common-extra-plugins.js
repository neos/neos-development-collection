({
    ...
    paths: {
		...
		"jquery": "empty:",
		//"jquery": "../../../../../Scripts/jquery-wrapper",
    	//"jquery": 'vendor/jquery-1.7.2',

		// We want to use our own jQuery UI, and NOT the Aloha one.
		// Ours has some patches to work correctly.
    ...
    //modules: [
        ...
        //{
            name: "aloha",
			out: "src/target/build-profile-with-common-extra-plugins/rjs-output/optimized-aloha.js",
			include: [
				// all common plugins
				"ui/ui-plugin",
				"link/link-plugin",
    ...
    wrap: {
        startFile: "src/build/aloha/closure-start.frag",
        endFile: "src/build/aloha/closure-end.frag"
    },
