...
use TYPO3\Neos\TypoScript\FlowQueryOperations\CacheLifetimeOperation;
use TYPO3\Neos\TypoScript\FlowQueryOperations\ContextOperation;
use TYPO3\TYPO3CR\Domain\Model\NodeInterface;

/**
 * Testcase for the Neos FlowQuery CacheLifetimeOperation
 */
