...
class NodePrivilegeContext
{
    ...
    public function isAncestorNodeOf(string $nodePathOrIdentifier): bool
    {
        ...
        return str_starts_with($nodePathOrResult, $this->getSubgraph()->retrieveNodePath($this->node->nodeAggregateId)->serializeToString());
    }
    ...
    public function isDescendantNodeOf(string $nodePathOrIdentifier): bool
    {
        ...
        return str_starts_with($this->getSubgraph()->retrieveNodePath($this->node->nodeAggregateId)->serializeToString(), $nodePathOrResult);
    }
    ...
    protected function resolveNodePathOrResult(string $nodePathOrIdentifier): bool|string
    {
        try {
            ...
            return $this->getSubgraph()->retrieveNodePath($otherNode->nodeAggregateId)->serializeToString() . '/';
