...
Feature: Find nodes using the findPrecedingSiblings query
  ...
  Scenario: findPrecedingSiblings queries with result
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" and filter '{"nodeTypeConstraints": "Neos.ContentRepository.Testing:NonExisting"}' I expect no nodes to be returned
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" I expect the nodes "a5,a4,a3,a2,a1" to be returned
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" and filter '{"nodeTypeConstraints": "Neos.ContentRepository.Testing:Page"}' I expect the nodes "a5,a3,a2,a1" to be returned
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" and filter '{"nodeTypeConstraints": "!Neos.ContentRepository.Testing:Page"}' I expect the nodes "a4" to be returned
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" and filter '{"limit": 3, "offset": 1}' I expect the nodes "a4,a3,a2" to be returned
    When I execute the findPrecedingSiblings query for sibling node aggregate id "a6" and filter '{"nodeTypeConstraints": "Neos.ContentRepository.Testing:Page,Neos.ContentRepository.Testing:NonExisting", "limit": 4, "offset": 2}' I expect the nodes "a2,a1" to be returned
