...
Feature: Find nodes using the findAncestorNodes queries
  ...
  Scenario:
    ...
    # TODO is this correct, that we include the lady?
    When I execute the findAncestorNodes query for entry node aggregate id "home" I expect the nodes "lady-eleonode-rootford" to be returned

    When I execute the findAncestorNodes query for entry node aggregate id "a2" I expect the nodes "a,home,lady-eleonode-rootford" to be returned
    When I execute the findAncestorNodes query for entry node aggregate id "a2a2b" I expect the nodes "a2a2,a2a,a2,a,home,lady-eleonode-rootford" to be returned
