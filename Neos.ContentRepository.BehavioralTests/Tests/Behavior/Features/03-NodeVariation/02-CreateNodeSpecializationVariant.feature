Feature: Create node specialization
  ...
  Scenario: Create specialization of node to dimension space point with further specializations
    ...
    And event at index 10 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"source"},"nodeAggregateId":"younger-mc-nodeface"},{"dimensionSpacePoint":{"example":"spec"},"nodeAggregateId":"younger-mc-nodeface"}] |
  ...
  Scenario: Create specialization of node to dimension space point with specializations that are partially occupied
    ...
    And event at index 13 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | sourceOrigin           | {"example":"general"}                                                                 |
      | specializationOrigin   | {"example":"source"}                                                                   |
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"source"},"nodeAggregateId":"younger-mc-nodeface"}] |
    And event at index 14 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | sourceOrigin           | {"example":"general"}                                                                    |
      | specializationOrigin   | {"example":"source"}                                                                      |
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"source"},"nodeAggregateId":"invariable-mc-nodeface"}] |
    And event at index 15 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | sourceOrigin           | {"example":"general"}                                                |
      | specializationOrigin   | {"example":"source"}                                                  |
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"source"},"nodeAggregateId":null}] |
    ...
    And I expect the node aggregate "nody-mc-nodeface" to exist
    And I expect this node aggregate to occupy dimension space points [{"example":"general"},{"example":"source"},{"example":"spec"}]
    And I expect this node aggregate to cover dimension space points [{"example":"general"},{"example":"source"},{"example":"spec"}]
