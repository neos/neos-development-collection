...
Feature: Create node specialization
  ...
  to a more general dimension space point
  ...
  * after the last of its new siblings, which does not exist in all variants
  ...
  Background:
    ...
    And the following CreateNodeAggregateWithNode commands are executed:
      | nodeAggregateId            | originDimensionSpacePoint | nodeName          | nodeTypeName                                | parentNodeAggregateId      | tetheredDescendantNodeAggregateIds                                                         |
      | sir-david-nodenborough     | {"example":"general"}     | parent-document   | Neos.ContentRepository.Testing:LeafDocument | lady-eleonode-rootford     | {}                                                                                         |
      | eldest-mc-nodeface         | {"example":"general"}     | eldest-document   | Neos.ContentRepository.Testing:LeafDocument | sir-david-nodenborough     | {}                                                                                         |
      | elder-mc-nodeface          | {"example":"general"}     | elder-document    | Neos.ContentRepository.Testing:LeafDocument | sir-david-nodenborough     | {}                                                                                         |
      | younger-mc-nodeface        | {"example":"general"}     | younger-document  | Neos.ContentRepository.Testing:LeafDocument | sir-david-nodenborough     | {}                                                                                         |
      | youngest-mc-nodeface       | {"example":"general"}     | youngest-document | Neos.ContentRepository.Testing:LeafDocument | sir-david-nodenborough     | {}                                                                                         |
      | sir-nodeward-nodington-iii | {"example":"source"}      | esquire           | Neos.ContentRepository.Testing:LeafDocument | lady-eleonode-rootford     | {}                                                                                         |
      | nody-mc-nodeface           | {"example":"source"}      | document          | Neos.ContentRepository.Testing:Document     | sir-nodeward-nodington-iii | {"tethered-node": "nodewyn-tetherton", "tethered-node/tethered-leaf": "nodimer-tetherton"} |
      | invariable-mc-nodeface     | {"example":"source"}      | invariable        | Neos.ContentRepository.Testing:LeafDocument | nody-mc-nodeface           | {}                                                                                         |

  Scenario: Create generalization variant to a new parent before the first of its new siblings
    ...
    And event at index 12 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | nodeAggregateId        | "nody-mc-nodeface"                                                                                                                                                      |
      | sourceOrigin           | {"example":"source"}                                                                                                                                                   |
      | specializationOrigin   | {"example":"general"}                                                                                                                                                    |
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"general"},"nodeAggregateId":"eldest-mc-nodeface"},{"dimensionSpacePoint":{"example":"peer"},"nodeAggregateId":"eldest-mc-nodeface"}] |
      | parentNodeAggregateId  | "sir-david-nodenborough"                                                                                                                                                |
    And event at index 13 is of type "NodeSpecializationVariantWasCreated" with payload:
      ...
      | sourceOrigin           | {"example":"source"}                                                                                                                                                           |
      | specializationOrigin   | {"example":"general"}                                                                                                                                                            |
      | specializationSiblings | [{"dimensionSpacePoint":{"example":"general"},"nodeAggregateId":"invariable-mc-nodeface"},{"dimensionSpacePoint":{"example":"peer"},"nodeAggregateId":"invariable-mc-nodeface"}] |
    ...
    And I expect the graph projection to consist of exactly 14 nodes
    ...
    And I expect node aggregate identifier "sir-david-nodenborough" to lead to node cs-identifier;sir-david-nodenborough;{"example":"general"}
  ...
  # As this is implemented via deletion of a specialization: @see ../07-NodeRemoval/07-CreateNodeSpecializationVariant-NewParent-AfterDeletion.feature

  Scenario: Create specialization variant to a new parent after the last of its new siblings
    When the command CreateNodeVariant is executed with payload:
      | Key                             | Value                    |
      | nodeAggregateId                 | "nody-mc-nodeface"       |
      | sourceOrigin                    | {"example":"general"}    |
      | targetOrigin                    | {"example":"source"}     |
      | parentNodeAggregateId           | "sir-david-nodenborough" |
      | precedingSiblingNodeAggregateId | "youngest-mc-nodeface"   |
    Then I expect exactly 15 events to be published on stream "ContentStream:cs-identifier"
    And event at index 12 is of type "NodeSpecializationVariantWasCreated" with payload:
      | Key                    | Expected                                                                                                                                |
      | contentStreamId        | "cs-identifier"                                                                                                                         |
  ...
  # Scenario: Create specialization variant to a new parent after the last of its new siblings, which does not exist in all variants
  # As this is implemented via deletion of a specialization: @see ../07-NodeRemoval/07-CreateNodeSpecializationVariant-NewParent-AfterDeletion.feature
