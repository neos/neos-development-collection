...
namespace Neos\Neos\EventSourcedSiteAndWorkspace\Domain\Context\ContentStream;
...
use Neos\Neos\EventSourcedSiteAndWorkspace\Domain\Model\User;
        ...
        if ($isEditor) {
            ...
            if ($user instanceof User) {
                ...
                if (!$workspace) {
                    ...
                    $workspaceName = \Neos\Neos\EventSourcedSiteAndWorkspace\Domain\Context\Workspace\WorkspaceName::fromAccountIdentifier($token->getAccount()->getAccountIdentifier());
