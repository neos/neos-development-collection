...
Since some refactoring has happened, developers will need to get familiar with a few changes.
...
and will reduce the number of different version constraints we have to deal with.
