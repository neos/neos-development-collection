...
.. _`Content Repository Signals Reference: PublishingService (``Neos\ContentRepository\Service\PublishingService``)`:

PublishingService (``Neos\ContentRepository\Service\PublishingService``)
---------------------------------------------------------------
