...
final class DetectContentSubgraphComponent implements Http\Component\ComponentInterface
{
    ...
    /**
     * @Flow\Inject
     * @var ContentDimensionDetection\DimensionPresetDetectorResolver
     */
    ...
    public function handle(Http\Component\ComponentContext $componentContext)
    {
        ...
        $workspaceName = $this->detectContentStreamIdentifier($componentContext);
    ...
    protected function sortPresetsByOffset(array & $presets): void
    {
    ...
    /**
     * @todo remove once legacy configuration is removed (probably with 5.0)
     * @param array $presetConfiguration
     * @param int $uriPathSegmentOffset
     * @return array|null
     */
    protected function generateOptionsFromLegacyConfiguration(array $presetConfiguration, int $uriPathSegmentOffset): ?array
    {
        $options = null;
    ...
    protected function detectContentStreamIdentifier(Http\Component\ComponentContext $componentContext): string
    {
