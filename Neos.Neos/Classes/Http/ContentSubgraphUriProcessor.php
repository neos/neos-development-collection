...
final class ContentSubgraphUriProcessor implements ContentSubgraphUriProcessorInterface
{
    ...
    /**
     * @Flow\Inject
     * @var ContentDimensionLinking\DimensionPresetLinkProcessorResolver
     */
    ...
    protected function sortDimensionValuesByOffset(array & $dimensionValues, array $presets): void
    {
