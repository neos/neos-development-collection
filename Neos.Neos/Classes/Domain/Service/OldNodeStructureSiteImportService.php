...
use Neos\ContentRepository\Domain\Service\ImportExport\OldNodeStructureNodeImportService;
 ...
 * @api
 */
class OldNodeStructureSiteImportService
{
    /**
     * @Flow\Inject
    ...
    /**
     * @Flow\Inject
     * @var OldNodeStructureNodeImportService
     */
