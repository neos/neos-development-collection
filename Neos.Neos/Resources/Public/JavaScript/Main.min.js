...
/***/ "./Resources/Public/JavaScript/Components/TopBar/UserMenu.js":
/*!*******************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/TopBar/UserMenu.js ***!
  \*******************************************************************/
...
class UserMenu {
  constructor(_root) {
    ...
    this._csrfToken = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(csfrTokenField) ? csfrTokenField.getAttribute('data-csrf-token') : '';
    this._root = _root;
    this._apiService = new _Services__WEBPACK_IMPORTED_MODULE_1__.ApiService(BASE_PATH, this._csrfToken);
...
const hasConfiguration = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS?.Configuration);
const init = () => {
...
const localizedTooltip = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.Typo3Neos) ? window.NeosCMS.I18n.translate('impersonate.tooltip.impersonateUserButton', 'Login as this user', 'Neos.Neos') : 'Login as this user';
...
const RestoreButton = user => {
  ...
  const restoreLabel = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS) ? window.NeosCMS.I18n.translate('impersonate.label.restoreUserButton', 'Back to user "{0}"', 'Neos.Neos', 'Main', user.accountIdentifier) : `Restore user "${user.accountIdentifier}"`;
...
/* harmony export */   "UserMenu": () => (/* reexport safe */ _UserMenu__WEBPACK_IMPORTED_MODULE_3__["default"])
/* harmony export */ });
...
/* harmony import */ var _UserMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UserMenu */ "./Resources/Public/JavaScript/Components/TopBar/UserMenu.js");
...
/* harmony import */ var _Components_DropDown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/DropDown */ "./Resources/Public/JavaScript/Components/DropDown.ts");
/* harmony import */ var _Components_DropDownGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/DropDownGroup */ "./Resources/Public/JavaScript/Components/DropDownGroup.ts");
/* harmony import */ var _Components_Tree__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/Tree */ "./Resources/Public/JavaScript/Components/Tree.ts");
/* harmony import */ var _Components_Modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/Modal */ "./Resources/Public/JavaScript/Components/Modal.ts");
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Services */ "./Resources/Public/JavaScript/Services/index.js");
/* harmony import */ var _Services_ResourceCache__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Services/ResourceCache */ "./Resources/Public/JavaScript/Services/ResourceCache.js");
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
...
// init API's
_Services__WEBPACK_IMPORTED_MODULE_7__.Helper.init();
_Services__WEBPACK_IMPORTED_MODULE_7__.Configuration.init();
_Services__WEBPACK_IMPORTED_MODULE_7__.Notification.init();
_Services__WEBPACK_IMPORTED_MODULE_7__.Localization.init();
(0,_Services_ResourceCache__WEBPACK_IMPORTED_MODULE_8__.cachedFetch)(_Services__WEBPACK_IMPORTED_MODULE_7__.Configuration.get("XliffUri")).then(xliffData => {
  if (xliffData) {
    _Services__WEBPACK_IMPORTED_MODULE_7__.Localization.initTranslations(xliffData);
  }
});
document.addEventListener("DOMContentLoaded", event => {
  ...
  treeElements.forEach(treeElement => {
    new _Components_Tree__WEBPACK_IMPORTED_MODULE_5__["default"](treeElement);
  });
  ...
  modalTrigger.forEach(_modalTrigger => {
    ...
    if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_9__.isNil)(modalElement)) {
      new _Components_Modal__WEBPACK_IMPORTED_MODULE_6__["default"](modalElement);
    }
  });
  ...
  expandableElements.forEach(expandableElement => {
    new _Components_DropDown__WEBPACK_IMPORTED_MODULE_3__["default"](expandableElement);
  });
  ...
  expandableGroupElements.forEach(expandableElement => {
    new _Components_DropDownGroup__WEBPACK_IMPORTED_MODULE_4__["default"](expandableElement);
  });
  const userModuleContainer = document.querySelector('.neos-module-administration-users');
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_9__.isNil)(userModuleContainer)) {
    Array.from(userModuleContainer.querySelectorAll('.neos-table')).forEach(_userModule => {
      if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_9__.isNil)(_userModule)) {
  ...
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_9__.isNil)(userMenuContainer)) {
    new _Components_TopBar__WEBPACK_IMPORTED_MODULE_1__.UserMenu(userMenuContainer);
  }
});
})();
