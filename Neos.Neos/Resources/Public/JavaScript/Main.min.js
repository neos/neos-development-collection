...
/***/ "./Resources/Public/JavaScript/Components/UserMenu.js":
/*!************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/UserMenu.js ***!
  \************************************************************/
...
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Services */ "./Resources/Public/JavaScript/Services/index.js");
/* harmony import */ var _Templates_RestoreButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Templates/RestoreButton */ "./Resources/Public/JavaScript/Templates/RestoreButton.js");
...
class UserMenu {
  constructor(_root) {
    ...
    this._csrfToken = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(userMenuElement) ? '' : userMenuElement.getAttribute('data-csrf-token');
    this._baseModuleUri = this._getBaseModuleUri(userMenuElement);
    this._basePath = this._getImpersonationBasePath();
    this._root = _root;
    this._apiService = new _Services__WEBPACK_IMPORTED_MODULE_1__.ApiService(this._basePath, this._csrfToken);
    if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_root)) {
      this._checkImpersonateStatus();
    }
  }
  _getBaseModuleUri(element) {
    let url = '/neos';
    if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(element) && element.hasAttribute('data-module-basepath')) {
  ...
  _renderRestoreButton(user) {
    ...
    if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(userMenuDropDown) || (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(user)) {
      return false;
    }

    // append restore button to the user menu
    const restoreListItem = document.createElement('li');
    restoreListItem.innerHTML = (0,_Templates_RestoreButton__WEBPACK_IMPORTED_MODULE_2__.RestoreButton)(user);
    userMenuDropDown.appendChild(restoreListItem);

    // add event listener for restore api call
    const restoreButtonElement = userMenuDropDown.querySelector('.restore-user');
    if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(restoreButtonElement)) {
      restoreButtonElement.addEventListener('click', this._restoreUser.bind(this));
    }
  }
  _checkImpersonateStatus() {
    ...
    response.then(data => {
      ...
      if (status && !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(origin)) {
  ...
  _restoreUser(event) {
    ...
    if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(button)) {
      return false;
    }
    ...
    response.then(data => {
      ...
      const message = window.NeosCMS.I18n.translate('impersonate.success.restoreUser', 'Switched back from {0} to the orginal user {1}.', 'Neos.Neos', 'Main', {
      ...
      if (window.NeosCMS) {
        const message = window.NeosCMS.I18n.translate('impersonate.error.restoreUser', 'Could not switch back to the original user.', 'Neos.Neos');
...
/***/ "./Resources/Public/JavaScript/Module/Administration/UserManagement.js":
/*!*****************************************************************************!*\
  !*** ./Resources/Public/JavaScript/Module/Administration/UserManagement.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Services */ "./Resources/Public/JavaScript/Services/index.js");
/* harmony import */ var _Templates_ImpersonateButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Templates/ImpersonateButton */ "./Resources/Public/JavaScript/Templates/ImpersonateButton.js");
...
class UserManagement {
  ...
  _renderImpersonateButtons() {
    ...
    userTableActionButtons.forEach(_actionContainer => {
      ...
      if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(showButton)) {
        return false;
      }
      ...
      const isCurrentUser = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(deleteButton) && deleteButton.classList.contains('neos-disabled');
      const impersonateButtonMarkup = (0,_Templates_ImpersonateButton__WEBPACK_IMPORTED_MODULE_2__.ImpersonateButton)(userIdentifier, isCurrentUser);
  ...
  _impersonateUser(event) {
    ...
    response.then(data => {
      ...
      const username = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(user) ? '' : user.accountIdentifier;
      const message = window.NeosCMS.I18n.translate('impersonate.success.impersonateUser', 'Switched to the new user {0}.', 'Neos.Neos', 'Main', {
        0: username
      });
      window.NeosCMS.Notification.ok(message);
...
/***/ "./Resources/Public/JavaScript/Module/Administration/index.js":
/*!********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Module/Administration/index.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "UserManagement": () => (/* reexport safe */ _UserManagement__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _UserManagement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./UserManagement */ "./Resources/Public/JavaScript/Module/Administration/UserManagement.js");



/***/ }),

/***/ "./Resources/Public/JavaScript/Services/ApiService.js":
/*!************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/ApiService.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ApiService {
  constructor(_basePath, _csrfToken) {
    if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_basePath)) {
    ...
    if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_csrfToken)) {
...
/***/ "./Resources/Public/JavaScript/Services/Configuration.js":
/*!***************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/Configuration.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let hasConfiguration = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS?.Configuration);
const init = () => {
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS)) {
    window.NeosCMS = {};
  }
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS.Configuration)) {
  ...
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(xliffLink)) {
...
const get = key => {
  ...
  return (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.getCollectionValueByPath)(window.NeosCMS.Configuration, key);
};
...
/***/ "./Resources/Public/JavaScript/Services/Helper.js":
/*!********************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/Helper.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const init = () => {
  ...
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS.Helper)) {
    window.NeosCMS.Helper = {
      isNil: _Helper__WEBPACK_IMPORTED_MODULE_0__.isNil,
      isEmpty: _Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty,
      getItemByKeyValue: _Helper__WEBPACK_IMPORTED_MODULE_0__.getItemByKeyValue,
      getCollectionValueByPath: _Helper__WEBPACK_IMPORTED_MODULE_0__.getCollectionValueByPath,
      createCollectionByPath: _Helper__WEBPACK_IMPORTED_MODULE_0__.createCollectionByPath
    };
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
/***/ "./Resources/Public/JavaScript/Services/LocalStorage.js":
/*!**************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/LocalStorage.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const getStorage = () => {
  ...
  return (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(storageJson) ? {} : storageJson;
};
const loadStorageData = path => {
  const storage = getStorage();
  const storageData = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.getCollectionValueByPath)(storage, path);
  return storageData;
};
const saveStorageData = (path, value) => {
  const storage = getStorage();
  const updatedStorageData = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.createCollectionByPath)(storage, path, value);
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(updatedStorageData)) {
...
/***/ "./Resources/Public/JavaScript/Services/Localization.js":
/*!**************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/Localization.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
...
const getTransformedNamespace = (packageName, sourceName) => {
  const dottedPackageName = (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(packageName) ? DEFAULT_PACKAGE : packageName.replace(/\_/g, ".");
  const dottedSourceName = (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(sourceName) ? DEFAULT_SOURCE : sourceName.replace(/\_/g, ".");
...
const getNamespace = (packageName, sourceName) => {
  const dottedPackageName = (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(packageName) ? DEFAULT_PACKAGE : packageName.trim();
  const dottedSourceName = (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(sourceName) ? DEFAULT_SOURCE : sourceName.trim();
  return dottedPackageName + "/" + dottedSourceName;
};
...
const getCurrentLanguage = () => {
  const xliffUri = (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.getCollectionValueByPath)(window.NeosCMS, "Configuration.XliffUri");
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(xliffUri)) {
    return "";
  }
...
const setInitialized = initialised => {
  (0,_Helper__WEBPACK_IMPORTED_MODULE_1__.createCollectionByPath)(window, "NeosCMS.I18n.initialized", Boolean(initialised));
};
...
const initializeExistingNamespaces = xliffData => {
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(xliffData)) {
    return false;
  }
  ...
  packageNames.forEach(packageName => {
    ...
    Sources.forEach(sourceName => {
      ...
      if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(translations)) {
        EXISTING_NAMESPACES.push({
          name: namespace,
          initialized: false
        });
      }
...
const checkInitialisedNamespaces = () => {
  const hasNonInitializedNamespaces = EXISTING_NAMESPACES.findIndex(namespace => namespace.initialized === false) >= 0;
  if (!hasNonInitializedNamespaces) {
    setInitialized(true);
    window.dispatchEvent(new CustomEvent("neoscms-i18n-initialized", {
      bubbles: true
    }));
  }
...
const transformAndAppendXliffData = xliffData => {
  const language = i18next__WEBPACK_IMPORTED_MODULE_0__["default"].languages[0];
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(xliffData)) {
    return false;
  }
  const packageNames = Object.keys(xliffData);
  i18next__WEBPACK_IMPORTED_MODULE_0__["default"].store.on("added", (lng, ns) => {
    // set namespace as initialized
    EXISTING_NAMESPACES.find(entry => entry.name === ns)["initialized"] = true;
  ...
  packageNames.forEach(packageName => {
    ...
    Sources.forEach(sourceName => {
      ...
      const translations = xliffData[packageName][sourceName];
      if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(translations)) {
        i18next__WEBPACK_IMPORTED_MODULE_0__["default"].addResourceBundle(language, namespace, flattenPluralItems(translations), true, true);
      }
    });
  });
};
 ...
 * @returns {string}
 */
const translate = (id, fallback, packageKey, source, parameters, context, quantity) => {
  id = id.replace(/\./g, "_");
  const namespace = getNamespace(packageKey, source);
  const identifier = namespace + ":" + id.trim();
  let options = {};
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(quantity)) {
    options["count"] = quantity;
  }
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(parameters)) {
    options["replace"] = parameters;
  }
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(fallback)) {
    options["defaultValue"] = fallback;
  }
  return i18next__WEBPACK_IMPORTED_MODULE_0__["default"].t(identifier, options);
};
const init = () => {
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(window.NeosCMS)) {
    window.NeosCMS = {};
  }
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(window.NeosCMS.I18n)) {
    window.NeosCMS.I18n = {
      init: init,
      translate: translate,
      initialized: false
...
const initTranslations = xliffData => {
  ...
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isEmpty)(currentLangauge)) {
    // If the current language is not ISO-2 then we can not use the preferred language
    const languageOption = currentLangauge.match("[a-z]{2}(-[A-Z]{2})") ? "lng" : "fallbackLng";
    options[languageOption] = currentLangauge;
  }
  initializeExistingNamespaces(xliffData);

  // append translation resources
  i18next__WEBPACK_IMPORTED_MODULE_0__["default"].init(options, (err, t) => {
...
/***/ "./Resources/Public/JavaScript/Services/Notification.js":
/*!**************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/Notification.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Components_Notification_Toast__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Components/Notification/Toast */ "./Resources/Public/JavaScript/Components/Notification/Toast.ts");
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
...
const _renderNotification = (title, message, type, additionalOptions) => {
  ...
  _Components_Notification_Toast__WEBPACK_IMPORTED_MODULE_0__["default"].create(options);
};
 ...
 */
const clear = () => {
  _Components_Notification_Toast__WEBPACK_IMPORTED_MODULE_0__["default"].removeAll();
};
const init = () => {
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(window.NeosCMS)) {
    window.NeosCMS = {};
  }
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(window.NeosCMS.Notification)) {
  ...
  const notifications = Array.from(document.querySelectorAll("#neos-notifications-inline li"));
...
/***/ "./Resources/Public/JavaScript/Services/ResourceCache.js":
/*!***************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/ResourceCache.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _SessionStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SessionStorage */ "./Resources/Public/JavaScript/Services/SessionStorage.js");
...
const cachedFetch = async resourceUri => {
  const cachedData = _SessionStorage__WEBPACK_IMPORTED_MODULE_1__["default"].getItem(resourceUri);
  const noCachedEntry = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(cachedData);
  if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(resourceUri) && noCachedEntry) {
    return false;
  }
  if (noCachedEntry) {
    const responseData = await fetchData(resourceUri);
    _SessionStorage__WEBPACK_IMPORTED_MODULE_1__["default"].setItem(resourceUri, responseData);
    return responseData;
  } else {
    return cachedData;
  }
...
/***/ "./Resources/Public/JavaScript/Services/SessionStorage.js":
/*!****************************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/SessionStorage.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./Resources/Public/JavaScript/Services/index.js":
/*!*******************************************************!*\
  !*** ./Resources/Public/JavaScript/Services/index.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ApiService": () => (/* reexport safe */ _ApiService__WEBPACK_IMPORTED_MODULE_4__["default"]),
/* harmony export */   "Configuration": () => (/* reexport safe */ _Configuration__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "Helper": () => (/* reexport safe */ _Helper__WEBPACK_IMPORTED_MODULE_5__["default"]),
/* harmony export */   "Localization": () => (/* reexport safe */ _Localization__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   "Notification": () => (/* reexport safe */ _Notification__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "SessionStorage": () => (/* reexport safe */ _SessionStorage__WEBPACK_IMPORTED_MODULE_3__["default"])
/* harmony export */ });
/* harmony import */ var _Configuration__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Configuration */ "./Resources/Public/JavaScript/Services/Configuration.js");
/* harmony import */ var _Notification__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Notification */ "./Resources/Public/JavaScript/Services/Notification.js");
/* harmony import */ var _Localization__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Localization */ "./Resources/Public/JavaScript/Services/Localization.js");
/* harmony import */ var _SessionStorage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SessionStorage */ "./Resources/Public/JavaScript/Services/SessionStorage.js");
/* harmony import */ var _ApiService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ApiService */ "./Resources/Public/JavaScript/Services/ApiService.js");
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Helper */ "./Resources/Public/JavaScript/Services/Helper.js");
...
/***/ "./Resources/Public/JavaScript/Templates/ImpersonateButton.js":
/*!********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Templates/ImpersonateButton.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ImpersonateButton": () => (/* binding */ ImpersonateButton)
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");

const impersonateIcon = '<i class="fas fa-random icon-white"></i>';
const ImpersonateButton = (identifier, disabled) => {
  const localizedTooltip = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS) ? window.NeosCMS.I18n.translate('impersonate.tooltip.impersonateUserButton', 'Login as this user', 'Neos.Neos') : 'Login as this user';
  ...
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(disabled) && disabled === true) {
...
/***/ "./Resources/Public/JavaScript/Templates/RestoreButton.js":
/*!****************************************************************!*\
  !*** ./Resources/Public/JavaScript/Templates/RestoreButton.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RestoreButton": () => (/* binding */ RestoreButton)
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
...
const RestoreButton = user => {
  ...
  const restoreLabel = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(window.NeosCMS) ? window.NeosCMS.I18n.translate('impersonate.label.restoreUserButton', 'Back to user "{0}"', 'Neos.Neos', 'Main', [user.fullName]) : `Restore user "${user.fullName}"`;
...
/***/ "./Resources/Public/JavaScript/Components/DropDown.ts":
/*!************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/DropDown.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DropDown {
    constructor(_root, _triggerElement, _grouped) {
        const _trigger = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_triggerElement)
            ? _triggerElement
            : _root.querySelector(".neos-dropdown-trigger");
        const contentSelector = this.getContentSelector(_trigger);
        this.root = _root;
        this.trigger = _trigger;
        this.content = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(contentSelector)
            ? document.getElementById(contentSelector)
            : _root.querySelector(".neos-dropdown-content");
        this.grouped = (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_grouped) ? false : Boolean(_grouped);
        this.disabled = false;
        this.initialize();
     ...
     */
    initialize() {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.content)) {
            return;
        }
        const innerContent = this.content.innerHTML.trim();
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(innerContent)) {
    ...
    getContentSelector(_element) {
        return !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_element) ? _element.getAttribute("aria-controls") : "";
    }
    setupEventListeners() {
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.trigger) && !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.content) && !this.disabled) {
    ...
    toggle(_event) {
        ...
        const _state = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(_triggerState)
    ...
    close(_trigger) {
        ...
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_content)) {
...
/***/ "./Resources/Public/JavaScript/Components/DropDownGroup.ts":
/*!*****************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/DropDownGroup.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ DropDownGroup)
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _DropDown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DropDown */ "./Resources/Public/JavaScript/Components/DropDown.ts");
...
class DropDownGroup {
    ...
    initialize() {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.root)) {
            return;
        }
        const dropDownElements = Array.from(this.root.querySelectorAll(".neos-dropdown-trigger"));
        dropDownElements.forEach((_element) => {
            new _DropDown__WEBPACK_IMPORTED_MODULE_1__["default"](this.root, _element, true);
        });
    }
}
...
/***/ "./Resources/Public/JavaScript/Components/Modal.ts":
/*!*********************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/Modal.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Modal {
    ...
    getTriggerElement(_element) {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_element)) {
            return null;
        }
    ...
    handleDynamicHeader(_trigger) {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(_trigger) || (0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.header)) {
            return;
        }
        const dynamicHeader = _trigger.getAttribute("data-modal-header");
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(dynamicHeader)) {
...
/***/ "./Resources/Public/JavaScript/Components/Notification/Message.ts":
/*!************************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/Notification/Message.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _MessageTemplate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MessageTemplate */ "./Resources/Public/JavaScript/Components/Notification/MessageTemplate.ts");
...
class Message {
    ...
    initialize() {
        ...
        const htmlSafeTitle = dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(title);
        const htmlSafeMessage = dompurify__WEBPACK_IMPORTED_MODULE_0___default().sanitize(message);
        const messageMarkup = (0,_MessageTemplate__WEBPACK_IMPORTED_MODULE_2__.messageTemplate)(type, htmlSafeTitle, htmlSafeMessage, closeButton);
    ...
    registerExpandHandling(message) {
        ...
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(contentSection) &&
    ...
    registerCloseButton(message) {
        ...
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(closeButton)) {
    ...
    close() {
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_1__.isNil)(this.message)) {
...
/***/ "./Resources/Public/JavaScript/Components/Notification/MessageTemplate.ts":
/*!********************************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/Notification/MessageTemplate.ts ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const messageTemplate = (type, title, message, close) => {
    const hasMessage = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(message);
    const classNames = ["neos-notification-content"];
    const closeButton = !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(close) && close
...
/***/ "./Resources/Public/JavaScript/Components/Notification/Toast.ts":
/*!**********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/Notification/Toast.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
/* harmony import */ var _Message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Message */ "./Resources/Public/JavaScript/Components/Notification/Message.ts");
...
class Toast {
    ...
    initialize() {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this.container)) {
            const applicationContainer = document.getElementById("neos-application");
            if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(applicationContainer)) {
    ...
    create(options) {
        ...
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(toastOptions.position)) {
            this.container.classList.add(toastOptions.position);
        }
        new _Message__WEBPACK_IMPORTED_MODULE_1__["default"](toastOptions, this.container);
    }
    /**
    ...
    static create(options) {
        // @ts-ignore
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(this._container)) {
    ...
    static removeAll() {
        ...
        messages.forEach((messageElement) => {
            if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(messageElement)) {
...
/***/ "./Resources/Public/JavaScript/Components/TopBar/DropdownMenu.ts":
/*!***********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/TopBar/DropdownMenu.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./Resources/Public/JavaScript/Components/TopBar/Expandable.ts":
/*!*********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/TopBar/Expandable.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Expandable)
/* harmony export */ });
class Expandable {
...
/***/ "./Resources/Public/JavaScript/Components/TopBar/MenuPanel.ts":
/*!********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/TopBar/MenuPanel.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Expandable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Expandable */ "./Resources/Public/JavaScript/Components/TopBar/Expandable.ts");
/* harmony import */ var _Services_LocalStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Services/LocalStorage */ "./Resources/Public/JavaScript/Services/LocalStorage.js");
...
class MenuPanel {
    ...
    initializeMenuSections() {
        this.panel.forEach((_panel) => {
            ...
            menuSectionElements.forEach((menuSectionElement) => {
                ...
                new _Expandable__WEBPACK_IMPORTED_MODULE_0__["default"](menuSectionElement, ".neos-menu-panel-toggle", this.onMenuSectionStateChange.bind(this), sectionState);
            });
        });
    }
    setupEventListeners() {
    ...
    loadMenuSectionStates() {
        const storageData = (0,_Services_LocalStorage__WEBPACK_IMPORTED_MODULE_1__.loadStorageData)(VALUE_PATH);
        return Array.isArray(storageData) ? storageData : [];
    }
    saveMenuSectionStates() {
        if (Array.isArray(this.menuSectionStates)) {
            (0,_Services_LocalStorage__WEBPACK_IMPORTED_MODULE_1__.saveStorageData)(VALUE_PATH, this.menuSectionStates);
        }
    }
...
/***/ "./Resources/Public/JavaScript/Components/TopBar/index.ts":
/*!****************************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/TopBar/index.ts ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DropDownMenu": () => (/* reexport safe */ _DropdownMenu__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "Expandable": () => (/* reexport safe */ _Expandable__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "MenuPanel": () => (/* reexport safe */ _MenuPanel__WEBPACK_IMPORTED_MODULE_2__["default"])
/* harmony export */ });
/* harmony import */ var _DropdownMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DropdownMenu */ "./Resources/Public/JavaScript/Components/TopBar/DropdownMenu.ts");
/* harmony import */ var _Expandable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Expandable */ "./Resources/Public/JavaScript/Components/TopBar/Expandable.ts");
/* harmony import */ var _MenuPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MenuPanel */ "./Resources/Public/JavaScript/Components/TopBar/MenuPanel.ts");
...
/***/ "./Resources/Public/JavaScript/Components/Tree.ts":
/*!********************************************************!*\
  !*** ./Resources/Public/JavaScript/Components/Tree.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Tree {
    ...
    initializeTree() {
        this.nodes.forEach((_node) => {
            ...
            if (this.isFolder(_node) &&
                !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(hasSubnodes) &&
    ...
    initializeTreeState(items) {
        ...
        items.forEach((_item) => {
            ...
            if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(node)) {
    ...
    isFolder(node) {
        return !(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(node) && node.classList.contains("neos-tree-folder");
    }
    toggle(node) {
    ...
    getPathForType() {
        const path = VALUE_PATH + (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(this.type) ? "." + this.type : "");
        return path.toLowerCase();
    }
    loadTreeBranchStates(init) {
        const pathWithType = this.getPathForType();
        const storageData = (0,_Services_LocalStorage__WEBPACK_IMPORTED_MODULE_1__.loadStorageData)(pathWithType);
        if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isNil)(init) && init === true) {
    ...
    saveTreeBranchStates() {
        ...
        if (Array.isArray(this.treeBranchStates)) {
            (0,_Services_LocalStorage__WEBPACK_IMPORTED_MODULE_1__.saveStorageData)(pathWithType, this.treeBranchStates);
        }
    }
    changeTreeBranchState(path) {
        if ((0,_Helper__WEBPACK_IMPORTED_MODULE_0__.isEmpty)(path) || !Array.isArray(this.treeBranchStates)) {
            return;
        }
...
/***/ "./Resources/Public/JavaScript/Helper/createCollectionByPath.ts":
/*!**********************************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/createCollectionByPath.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (createCollectionByPath);


/***/ }),

/***/ "./Resources/Public/JavaScript/Helper/getCollectionValueByPath.ts":
/*!************************************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/getCollectionValueByPath.ts ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./Resources/Public/JavaScript/Helper/index.ts");

const getCollectionValueByPath = (collection, path) => {
    if ((0,___WEBPACK_IMPORTED_MODULE_0__.isNil)(collection)) {
        return null;
    }
    return path.split(".").reduce((value, index) => {
        if ((0,___WEBPACK_IMPORTED_MODULE_0__.isNil)(value)) {
            return null;
        }
        // @ts-ignore
        return value[index];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getCollectionValueByPath);


/***/ }),

/***/ "./Resources/Public/JavaScript/Helper/getItemByKeyValue.ts":
/*!*****************************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/getItemByKeyValue.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getItemByKeyValue);


/***/ }),

/***/ "./Resources/Public/JavaScript/Helper/index.ts":
/*!*****************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/index.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createCollectionByPath": () => (/* reexport safe */ _createCollectionByPath__WEBPACK_IMPORTED_MODULE_4__["default"]),
/* harmony export */   "getCollectionValueByPath": () => (/* reexport safe */ _getCollectionValueByPath__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   "getItemByKeyValue": () => (/* reexport safe */ _getItemByKeyValue__WEBPACK_IMPORTED_MODULE_2__["default"]),
/* harmony export */   "isEmpty": () => (/* reexport safe */ _isEmpty__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   "isNil": () => (/* reexport safe */ _isNil__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _isNil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isNil */ "./Resources/Public/JavaScript/Helper/isNil.ts");
/* harmony import */ var _isEmpty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./isEmpty */ "./Resources/Public/JavaScript/Helper/isEmpty.ts");
/* harmony import */ var _getItemByKeyValue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getItemByKeyValue */ "./Resources/Public/JavaScript/Helper/getItemByKeyValue.ts");
/* harmony import */ var _getCollectionValueByPath__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getCollectionValueByPath */ "./Resources/Public/JavaScript/Helper/getCollectionValueByPath.ts");
/* harmony import */ var _createCollectionByPath__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createCollectionByPath */ "./Resources/Public/JavaScript/Helper/createCollectionByPath.ts");
...
/***/ "./Resources/Public/JavaScript/Helper/isEmpty.ts":
/*!*******************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/isEmpty.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const isEmpty = (object) => {
    ...
    if ((0,_isNil__WEBPACK_IMPORTED_MODULE_0__["default"])(object)) {
        return true;
    }
...
/***/ "./Resources/Public/JavaScript/Helper/isNil.ts":
/*!*****************************************************!*\
  !*** ./Resources/Public/JavaScript/Helper/isNil.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Components_TopBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/TopBar */ "./Resources/Public/JavaScript/Components/TopBar/index.ts");
/* harmony import */ var _Module_Administration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Module/Administration */ "./Resources/Public/JavaScript/Module/Administration/index.js");
/* harmony import */ var _Components_UserMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/UserMenu */ "./Resources/Public/JavaScript/Components/UserMenu.js");
/* harmony import */ var _Components_DropDown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/DropDown */ "./Resources/Public/JavaScript/Components/DropDown.ts");
/* harmony import */ var _Components_DropDownGroup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/DropDownGroup */ "./Resources/Public/JavaScript/Components/DropDownGroup.ts");
/* harmony import */ var _Components_Tree__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/Tree */ "./Resources/Public/JavaScript/Components/Tree.ts");
/* harmony import */ var _Components_Modal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Components/Modal */ "./Resources/Public/JavaScript/Components/Modal.ts");
/* harmony import */ var _Services__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Services */ "./Resources/Public/JavaScript/Services/index.js");
/* harmony import */ var _Services_ResourceCache__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Services/ResourceCache */ "./Resources/Public/JavaScript/Services/ResourceCache.js");
/* harmony import */ var _Helper__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Helper */ "./Resources/Public/JavaScript/Helper/index.ts");
...
// init API's
_Services__WEBPACK_IMPORTED_MODULE_8__.Helper.init();
_Services__WEBPACK_IMPORTED_MODULE_8__.Configuration.init();
_Services__WEBPACK_IMPORTED_MODULE_8__.Notification.init();
_Services__WEBPACK_IMPORTED_MODULE_8__.Localization.init();
(0,_Services_ResourceCache__WEBPACK_IMPORTED_MODULE_9__.cachedFetch)(_Services__WEBPACK_IMPORTED_MODULE_8__.Configuration.get("XliffUri")).then(xliffData => {
  if (xliffData) {
    _Services__WEBPACK_IMPORTED_MODULE_8__.Localization.initTranslations(xliffData);
  }
});
document.addEventListener("DOMContentLoaded", event => {
  const dropDownMenuElements = document.querySelectorAll(".neos-user-menu");
  dropDownMenuElements.forEach(dropDownElement => {
    new _Components_TopBar__WEBPACK_IMPORTED_MODULE_1__.DropDownMenu(dropDownElement);
  });
  const menuPanelElements = document.querySelectorAll(".neos-menu");
  menuPanelElements.forEach(panelElement => {
    new _Components_TopBar__WEBPACK_IMPORTED_MODULE_1__.MenuPanel(panelElement);
  });
  const treeElements = document.querySelectorAll(".neos-tree-container");
  treeElements.forEach(treeElement => {
    new _Components_Tree__WEBPACK_IMPORTED_MODULE_6__["default"](treeElement);
  });
  const modalTrigger = Array.from(document.querySelectorAll('[data-toggle="modal"]'));
  modalTrigger.forEach(_modalTrigger => {
    const modalElement = document.querySelector(_modalTrigger.getAttribute("href"));
    if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_10__.isNil)(modalElement)) {
      new _Components_Modal__WEBPACK_IMPORTED_MODULE_7__["default"](modalElement);
    }
  });
  const expandableElements = document.querySelectorAll("[data-neos-expandable=dropdown]");
  expandableElements.forEach(expandableElement => {
    new _Components_DropDown__WEBPACK_IMPORTED_MODULE_4__["default"](expandableElement);
  });
  const expandableGroupElements = document.querySelectorAll("[data-neos-expandable=dropdown-group]");
  expandableGroupElements.forEach(expandableElement => {
    new _Components_DropDownGroup__WEBPACK_IMPORTED_MODULE_5__["default"](expandableElement);
  });
  const userModuleContainer = document.querySelector('.neos-module-administration-users');
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_10__.isNil)(userModuleContainer)) {
    Array.from(userModuleContainer.querySelectorAll('.neos-table')).forEach(_userModule => {
      if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_10__.isNil)(_userModule)) {
        new _Module_Administration__WEBPACK_IMPORTED_MODULE_2__.UserManagement(_userModule);
      }
    });
  }
  const userMenuContainer = document.querySelector('#neos-top-bar .neos-user-menu');
  if (!(0,_Helper__WEBPACK_IMPORTED_MODULE_10__.isNil)(userMenuContainer)) {
    new _Components_UserMenu__WEBPACK_IMPORTED_MODULE_3__["default"](userMenuContainer);
  }
});
})();
