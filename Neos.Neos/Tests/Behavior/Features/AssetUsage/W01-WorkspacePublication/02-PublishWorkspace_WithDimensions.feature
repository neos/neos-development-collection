...
Feature: Publish nodes with dimensions
  ...
  Scenario: Publish nodes from user workspace to a non live workspace
    ...
    And the command SetNodeProperties is executed with payload:
      ...
      | propertyValues            | {"assets": ["Asset:asset-2", "Asset:asset-1"], "text": "Some text"} |
    ...
    And I expect the AssetUsageService to have the following AssetUsages:
      ...
      | asset-2 | nody-mc-nodeface           | assets       | review-workspace | {"language": "de"}        |
      | asset-1 | nody-mc-nodeface           | assets       | review-workspace | {"language": "gsw"}       |
      | asset-2 | nody-mc-nodeface           | assets       | review-workspace | {"language": "gsw"}       |
      | asset-3 | sir-nodeward-nodington-iii | text         | review-workspace | {"language": "fr"}        |
