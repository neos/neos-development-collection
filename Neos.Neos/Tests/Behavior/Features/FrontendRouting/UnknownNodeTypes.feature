...
Feature: Basic routing functionality (match & resolve nodes with unknown types)
  ...
  Scenario:
    ...
    Then I expect the documenturipath table to contain exactly:
      ...
      | ""                   | "lady-eleonode-rootford"                                       | "lady-eleonode-rootford" | null                     | null                     | null                      | "Neos.Neos:Sites"                    | 0             |
      | ""                   | "lady-eleonode-rootford/shernode-homes"                        | "shernode-homes"         | "lady-eleonode-rootford" | null                     | null                      | "Neos.Neos:Test.Routing.Page"        | 0             |
      | "david-nodenborough" | "lady-eleonode-rootford/shernode-homes/sir-david-nodenborough" | "sir-david-nodenborough" | "shernode-homes"         | null                     | "unknown-nodetype"        | "Neos.Neos:Test.Routing.Page"        | 0             |
      | "non-existing"       | "lady-eleonode-rootford/shernode-homes/unknown-nodetype"       | "unknown-nodetype"       | "shernode-homes"         | "sir-david-nodenborough" | null                      | "Neos.Neos:Test.Routing.NonExisting" | 1             |
