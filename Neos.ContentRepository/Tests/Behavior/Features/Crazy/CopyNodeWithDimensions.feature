Feature: Copy node with dimension support
  ...
  Scenario: Copying a non-aggregate node creates a node variant in the other dimension if the node does not exist in the target dimension.
    ...
    And I copy the node into path "/sites/typo3cr/company/main/two-col/column1" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    When I get a node by path "/sites/typo3cr/company/main/two-col/column1/text0-1" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
  ...
  Scenario: Copying a non-aggregate node does a detached copy if the node exists already in the target dimension
    ...
    When I get a node by path "/sites/typo3cr/company/main/two-col/column0/text0" with the following context:
      | Language   | Workspace  |
      | en, mul_ZZ | user-admin |
    And I copy the node into path "/sites/typo3cr/company/main" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    When I get a node by path "/sites/typo3cr/company/main/text0-1" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    Then I should have one node
  ...
  Scenario: Copying an aggregate node does a detached copy for the aggregate and all children as well, so they have a different identity.
    When I get a node by path "/sites/typo3cr/about-us" with the following context:
      | Language   | Workspace  |
      | en, mul_ZZ | user-admin |
    And I copy the node into path "/sites/typo3cr/company" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    When I get a node by path "/sites/typo3cr/company/about-us-1" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    Then I should have one node
    ...
    When I get a node by path "/sites/typo3cr/company/about-us-1/main/text0" with the following context:
      | Language   | Workspace  |
      | de, mul_ZZ | user-admin |
    Then I should have one node
