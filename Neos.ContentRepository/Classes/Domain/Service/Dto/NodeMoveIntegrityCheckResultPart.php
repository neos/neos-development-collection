...
final class NodeMoveIntegrityCheckResultPart
{
    ...
    public static function noViolation(\Neos\ContentRepository\Domain\Service\Context $context, \Neos\ContentRepository\Domain\Service\ContentDimensionPresetSourceInterface $contentDimensionPresetSource): self
    {
    ...
    public static function violationNoParentInDimension(\Neos\ContentRepository\Domain\Service\Context $context, \Neos\ContentRepository\Domain\Service\ContentDimensionPresetSourceInterface $contentDimensionPresetSource): self
    {
