...
use Neos\ContentRepository\Intermediary\Migration\Dto\Transformations;
...
class TransformationFactory
{
    ...
    protected function resolveTransformationClassName(string $transformationName): string
    {
        ...
        $resolvedObjectName = $this->objectManager->getCaseSensitiveObjectName('Neos\ContentRepository\Intermediary\Migration\Transformations\\' . $transformationName);
        if ($resolvedObjectName !== null) {
            return $resolvedObjectName;
        }
