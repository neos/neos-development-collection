...
namespace Neos\ContentRepository\Intermediary\Migration\Filters;
...
use Neos\ContentRepository\Intermediary\Migration\Dto\Filters;
...
class FilterFactory
{
    ...
    protected function resolveFilterClass($name)
    {
        ...
        $possibleFullFilterName = 'Neos\ContentRepository\Intermediary\Migration\Filters\\' . $name;
