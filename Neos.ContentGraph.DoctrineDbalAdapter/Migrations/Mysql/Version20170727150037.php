...
class Version20170727150037 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE neos_contentgraph_hierarchyedge (parentnodesidentifieringraph VARCHAR(255) NOT NULL, childnodesidentifieringraph VARCHAR(255) NOT NULL, name VARCHAR(255) NULL, subgraphidentifier VARCHAR(255) NOT NULL, position INT NOT NULL, PRIMARY KEY(parentnodesidentifieringraph, subgraphidentifier, childnodesidentifieringraph)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE neos_contentgraph_node (identifieringraph VARCHAR(255) NOT NULL, identifierinsubgraph VARCHAR(255) NOT NULL, subgraphidentifier VARCHAR(255) NOT NULL, properties LONGTEXT NOT NULL COMMENT \'(DC2Type:flow_json_array)\', nodetypename VARCHAR(255) NOT NULL, PRIMARY KEY(identifieringraph)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    }
