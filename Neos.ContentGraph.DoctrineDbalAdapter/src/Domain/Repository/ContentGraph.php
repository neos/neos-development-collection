...
final class ContentGraph implements ContentGraphInterface
{
    ...
    public function __construct(
        ...
        public readonly ContentStreamDbIds $contentStreamDbIds,
    ) {
    ...
    public function findRootNodeAggregates(
        ...
        $rootNodeAggregateQueryBuilder = $this->nodeQueryBuilder->buildFindRootNodeAggregatesQuery($this->contentStreamDbIds, $filter);
    ...
    public function findParentNodeAggregates(
        ...
        $queryBuilder = $this->nodeQueryBuilder->buildBasicNodeAggregateQuery()
            ->innerJoin('n', $this->nodeQueryBuilder->hierarchyRelationQueryBuilder->selectHierarchyRowsForContentStream(), 'ch', 'ch.parentnodeanchor = n.relationanchorpoint')
    ...
    public function findAncestorNodeAggregateIds(NodeAggregateId $entryNodeAggregateId): NodeAggregateIds
    {
        $queryBuilderInitial = $this->createQueryBuilder()
            ...
            ->where('ch.contentstreamdbid = :contentStreamDbIds')
        ...
        $queryBuilderRecursive = $this->createQueryBuilder()
            ...
            ->where('ph.contentstreamdbid = :contentStreamDbIds');
        ...
        $queryBuilderCte = $this->createQueryBuilder()
            ...
            ->setParameter('contentStreamDbIds', $this->contentStreamDbIds->toIntArray(), ArrayParameterType::STRING)
    ...
    public function findChildNodeAggregates(
        ...
        $queryBuilder = $this->nodeQueryBuilder->buildChildNodeAggregateQuery($parentNodeAggregateId, $this->contentStreamDbIds);
        return $this->mapQueryBuilderToNodeAggregates($queryBuilder);
    }
    ...
    public function findParentNodeAggregateByChildOriginDimensionSpacePoint(NodeAggregateId $childNodeAggregateId, OriginDimensionSpacePoint $childOriginDimensionSpacePoint): ?NodeAggregate
    {
        $subQueryBuilder = $this->createQueryBuilder()
            ...
            ->innerJoin('pn', $this->nodeQueryBuilder->hierarchyRelationQueryBuilder->selectHierarchyRowsForContentStream('WHERE h.dimensionspacepointhash = :childOriginDimensionSpacePointHash'), 'ch', 'ch.parentnodeanchor = pn.relationanchorpoint')
            ->innerJoin('ch', $this->nodeQueryBuilder->tableNames->node(), 'cn', 'cn.relationanchorpoint = ch.childnodeanchor')
        ...
        $queryBuilder = $this->createQueryBuilder()
            ...
            ->innerJoin('n', $this->nodeQueryBuilder->hierarchyRelationQueryBuilder->selectHierarchyRowsForContentStream(), 'h', 'h.childnodeanchor = n.relationanchorpoint')
    ...
    public function getDimensionSpacePointsOccupiedByChildNodeName(NodeName $nodeName, NodeAggregateId $parentNodeAggregateId, OriginDimensionSpacePoint $parentNodeOriginDimensionSpacePoint, DimensionSpacePointSet $dimensionSpacePointsToCheck): DimensionSpacePointSet
    {
        $queryBuilder = $this->createQueryBuilder()
            ...
            ->andWhere('ph.contentstreamdbid = :contentStreamDbIds')
            ->andWhere('h.contentstreamdbid = :contentStreamDbIds')
    ...
    public function findNodeAggregatesTaggedBy(SubtreeTag $subtreeTag): NodeAggregates
    {
        $queryBuilder =  $this->createQueryBuilder()
            ...
            ->where('th.contentstreamdbid = :contentStreamDbIds')
