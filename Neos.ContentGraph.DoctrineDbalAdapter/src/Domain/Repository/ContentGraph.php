...
final class ContentGraph implements ContentGraphInterface
{
    ...
    public function findRootNodeAggregates(
        ...
        $queryBuilder = $this->createQueryBuilder()
            ->select('n.*, h.contentstreamid, h.name, dsp.dimensionspacepoint AS covereddimensionspacepoint')
    ...
    public function findNodeAggregateById(
        ...
        $queryBuilder = $this->createQueryBuilder()
            ->select('n.*, h.name, h.contentstreamid, dsp.dimensionspacepoint AS covereddimensionspacepoint, r.dimensionspacepointhash AS disableddimensionspacepointhash')
    ...
    public function findParentNodeAggregates(
        ...
        $queryBuilder = $this->createQueryBuilder()
            ->select('pn.*, ph.name, ph.contentstreamid, pdsp.dimensionspacepoint AS covereddimensionspacepoint, r.dimensionspacepointhash AS disableddimensionspacepointhash')
    ...
    private function buildChildNodeAggregateQuery(NodeAggregateId $parentNodeAggregateId, ContentStreamId $contentStreamId): QueryBuilder
    {
        return $this->createQueryBuilder()
            ->select('cn.*, ch.name, ch.contentstreamid, cdsp.dimensionspacepoint AS covereddimensionspacepoint, r.dimensionspacepointhash AS disableddimensionspacepointhash')
            ->from($this->tableNamePrefix . '_node', 'pn')
            ->innerJoin('pn', $this->tableNamePrefix . '_hierarchyrelation', 'ph', 'ph.childnodeanchor = pn.relationanchorpoint')
            ->innerJoin('pn', $this->tableNamePrefix . '_hierarchyrelation', 'ch', 'ch.parentnodeanchor = pn.relationanchorpoint')
