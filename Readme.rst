...
.. |Travis Build Status| image:: https://travis-ci.org/neos/neos-development-collection.svg?branch=2.2
...
.. |License| image:: https://poser.pugx.org/neos/neos-development-collection/license
   :target: https://packagist.org/packages/neos/neos-development-collection
.. |Docs| image:: https://img.shields.io/badge/documentation-2.2-blue.svg
   :target: https://neos.readthedocs.io/en/2.2/
   :alt: Documentation
.. |API| image:: https://img.shields.io/badge/API%20docs-2.2-blue.svg
   :target: http://neos.github.io/neos/2.2/
   :alt: API Docs
...
If you want to install Neos, please have a look at the documentation: https://neos.readthedocs.io/en/2.2/
