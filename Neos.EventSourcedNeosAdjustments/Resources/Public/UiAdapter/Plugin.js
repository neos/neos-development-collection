...
var _DimensionSwitcher = __webpack_require__(7);

var _DimensionSwitcher2 = _interopRequireDefault(_DimensionSwitcher);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Neos.EventSourcedNeosAdjustments.Ui:UiAdapter', {}, function (globalRegistry) {
    var containerRegistry = globalRegistry.get('containers');

    containerRegistry.set('SecondaryToolbar/DimensionSwitcher', _DimensionSwitcher2.default);
});
...
var SelectedPreset = function SelectedPreset(props) {
    var icon = props.icon,
    ...
    return _react2.default.createElement(
        'span',
        { key: dimensionName, className: _style2.default.selectPreset },
        _react2.default.createElement(_reactUiComponents.Icon, { className: _style2.default.dropDown__btnIcon, icon: icon, title: dimensionLabel }),
        presetLabel
    );
};
SelectedPreset.propTypes = {
    icon: _propTypes2.default.string.isRequired,
    dimensionLabel: _propTypes2.default.string.isRequired,
    presetLabel: _propTypes2.default.string.isRequired,
    dimensionName: _propTypes2.default.string.isRequired
};

var DimensionSelector = function DimensionSelector(props) {
    var icon = props.icon,
        dimensionLabel = props.dimensionLabel,
    ...
    var presetOptions = (0, _plowJs.$map)(function (presetConfiguration, presetName) {
        return (0, _plowJs.$transform)({
            label: (0, _plowJs.$get)('label'),
            value: presetName,
            disabled: (0, _plowJs.$get)('disabled')
        }, presetConfiguration);
    }, [], presets).toArray();

    var sortedPresetOptions = (0, _lodash2.default)(presetOptions, ['label']);

    var onPresetSelect = function onPresetSelect(presetName) {
        onSelect(dimensionName, presetName);
    };

    return _react2.default.createElement(
        'li',
        { key: dimensionName, className: _style2.default.dimensionCategory },
        _react2.default.createElement(
            'div',
            { className: _style2.default.dimensionLabel },
            _react2.default.createElement(_reactUiComponents.Icon, { icon: icon, padded: 'right', className: _style2.default.dimensionCategory__icon }),
            _react2.default.createElement(_neosUiI18n2.default, { id: dimensionLabel })
        ),
...
DimensionSelector.propTypes = {
    icon: _propTypes2.default.string.isRequired,
    dimensionLabel: _propTypes2.default.string.isRequired,
    presets: _propTypes2.default.object.isRequired,
    activePreset: _propTypes2.default.string.isRequired,
    dimensionName: _propTypes2.default.string.isRequired,
    isLoading: _propTypes2.default.bool,
    onSelect: _propTypes2.default.func.isRequired
};

var DimensionSwitcher = (_dec = (0, _reactRedux.connect)((0, _plowJs.$transform)({
    contentDimensions: _neosUiReduxStore.selectors.CR.ContentDimensions.byName,
    allowedPresets: _neosUiReduxStore.selectors.CR.ContentDimensions.allowedPresets,
    activePresets: _neosUiReduxStore.selectors.CR.ContentDimensions.activePresets
}), {
    selectPreset: _neosUiReduxStore.actions.CR.ContentDimensions.selectPreset,
    setAllowed: _neosUiReduxStore.actions.CR.ContentDimensions.setAllowed
}), _dec(_class = (_temp2 = _class2 = function (_PureComponent) {
    _inherits(DimensionSwitcher, _PureComponent);
    ...
    function DimensionSwitcher() {
        ...
        _classCallCheck(this, DimensionSwitcher);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DimensionSwitcher.__proto__ || Object.getPrototypeOf(DimensionSwitcher)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            isOpen: false,
            transientPresets: {},
            loadingPresets: {}
            ...
            if (_this.props.contentDimensions.count() === 1) {
                ...
                var contentDimensions = _neosUiBackendConnector2.default.get().endpoints.contentDimensions;

                var transientPresets = _extends({}, _this.state.transientPresets, _defineProperty({}, selectedDimensionName, presetName));
                // First we update transientPresets in state, and only then we can get relevant effectivePresets
                _this.setState({
                    transientPresets: transientPresets
                }, function () {
                    var effectivePresets = _this.getEffectivePresets();
                    Object.keys(effectivePresets).forEach(function (dimensionName) {
                        ...
                        if (dimensionName !== selectedDimensionName) {
                            ...
                            _this.setState({ loadingPresets: _defineProperty({}, dimensionName, true) });
                            // Query backend API for updated constraints
                            contentDimensions(dimensionName, effectivePresets).then(function (dimensionConfig) {
                                var allowedPresets = Object.keys((0, _plowJs.$get)([dimensionName, 'presets'], dimensionConfig));
                                _this.props.setAllowed(dimensionName, allowedPresets);
                                _this.setState({ loadingPresets: _defineProperty({}, dimensionName, false) });
                            });
                        }
                    });
                });
            }
        }, _this.handleApplyPresets = function () {
            _this.props.selectPreset(_this.state.transientPresets);
            _this.setState({ isOpen: false, transientPresets: {} });
    ...
    _createClass(DimensionSwitcher, [{
        key: 'render',
            ...
            return contentDimensionsObjectKeys.length ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    contentDimensionsObjectKeys.map(function (dimensionName) {
                        ...
                        var activePreset = _this2.getEffectivePresets()[dimensionName];
                        return _react2.default.createElement(DimensionSelector, {
                            isLoading: _this2.state.loadingPresets[dimensionName],
                            key: dimensionName,
                            dimensionName: dimensionName,
                            icon: icon,
                            dimensionLabel: (0, _plowJs.$get)('label', dimensionConfiguration),
                            presets: _this2.valuesForDimension(dimensionName),
                    ...
                    contentDimensions.count() > 1 && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _reactUiComponents.Button,
                            {
                                ...
                                style: 'lighter',
                                className: _style2.default.cancelButton
                            },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_neosUiI18n2.default, { id: 'Neos.Neos:Main:apply', fallback: 'Apply' })
                        )
                    )
                )
            ) : null;
        ...
        key: 'valuesForDimension',
        value: function valuesForDimension(dimensionName) {
            var _props2 = this.props,
                contentDimensions = _props2.contentDimensions,
                allowedPresets = _props2.allowedPresets;
    ...
    contentDimensions: _propTypes2.default.object.isRequired,
    activePresets: _propTypes2.default.object.isRequired,
    allowedPresets: _propTypes2.default.object.isRequired,
    selectPreset: _propTypes2.default.func.isRequired,
    setAllowed: _propTypes2.default.func.isRequired
}, _class2.defaultProps = {
    contentDimensions: new _immutable.Map(),
    allowedPresets: new _immutable.Map(),
    activePresets: new _immutable.Map()
}, _temp2)) || _class);
exports.default = DimensionSwitcher;
...
// module
exports.push([module.i, ".style__dropDown___2XpHe {\n    max-width: 352px;\n    border-right: 1px solid #3f3f3f;\n}\n.style__dropDown__btnIcon___2hjZf {\n    margin-right: .5em;\n}\n.style__cancelButton___qtRjc {\n    margin-right: 4px !important;\n}\n.style__dimensionLabel___13GAI {\n    margin-top: 8px;\n    margin-bottom: 4px;\n}\n.style__buttonGroup___1pIa_ {\n    text-align: right;\n    margin-top: 8px;\n}\n.style__selectPreset___9szP2 {\n    margin-right: 16px;\n}\n", ""]);

// exports
exports.locals = {
	"dropDown": "style__dropDown___2XpHe",
	"dropDown__btnIcon": "style__dropDown__btnIcon___2hjZf",
	"cancelButton": "style__cancelButton___qtRjc",
	"dimensionLabel": "style__dimensionLabel___13GAI",
	"buttonGroup": "style__buttonGroup___1pIa_",
	"selectPreset": "style__selectPreset___9szP2"
};
