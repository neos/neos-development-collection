...
namespace Neos\ContentRepository\Core\Feature\NodeAttributes\Command;
...
/**
 * Removes an attribute from the given node aggregate in the given content stream in a dimension space point using a given strategy
 *
 * @api commands are the write-API of the ContentRepository
 */
final class RemoveNodeAggregateAttribute implements
    CommandInterface,
    \JsonSerializable,
    ...
    MatchableWithNodeIdToPublishOrDiscardInterface
{
     ...
     * @param Attribute $attribute The attribute to remove from the node aggregate
     */
     ...
     * @param Attribute $attribute The attribute to remove from the node aggregate
     */
    public static function create(ContentStreamId $contentStreamId, NodeAggregateId $nodeAggregateId, DimensionSpacePoint $coveredDimensionSpacePoint, NodeVariantSelectionStrategy $nodeVariantSelectionStrategy, Attribute $attribute): self
    {
        return new self($contentStreamId, $nodeAggregateId, $coveredDimensionSpacePoint, $nodeVariantSelectionStrategy, $attribute);
    }
    ...
    public static function fromArray(array $array): self
    {
        return new self(
            ...
            Attribute::fromString($array['attribute'])
        );
    }
