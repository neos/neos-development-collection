...
/**
 * Add an attribute to the given node aggregate in the given content stream in a dimension space point using a given strategy
 *
 * @api commands are the write-API of the ContentRepository
 */
final class AddNodeAggregateAttribute implements
    CommandInterface,
    \JsonSerializable,
    ...
    MatchableWithNodeIdToPublishOrDiscardInterface
{
     ...
     * @param Attribute $attribute The attribute to add to the node aggregate
     */
