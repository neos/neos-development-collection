    ...
    RebasableToOtherWorkspaceInterface
{
     ...
     * @param ?RelationDistributionStrategy $relationDistributionStrategy The relation distribution strategy to be used ({@see RelationDistributionStrategy}). If null, the default one declared in the node type will be used ({@see NodeMove})
    ...
    public static function create(
        ...
        ?NodeAggregateId $newParentNodeAggregateId = null,
        ?NodeAggregateId $newPrecedingSiblingNodeAggregateId = null,
        ?NodeAggregateId $newSucceedingSiblingNodeAggregateId = null
    ): self {
        return new self(
            $workspaceName,
            $dimensionSpacePoint,
