...
final class NodeVariantAssignmentCollectionIsInvalid extends \DomainException
{
    ...
    {
        return new self('Given node variant assignment collection is invalid because it contains an item of another type than ' . NodeVariantAssignment::class, 1571045106);
    }
}
