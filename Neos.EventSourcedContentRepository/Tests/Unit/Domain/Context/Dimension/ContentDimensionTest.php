...
class ContentDimensionTest extends UnitTestCase
{
    ...
    /**
     * @expectedException \Neos\EventSourcedContentRepository\Domain\Context\Dimension\Exception\MissingContentDimensionValuesException
     * @test
     */
    ...
    /**
     * @test
     * @expectedException \Neos\EventSourcedContentRepository\Domain\Context\Dimension\Exception\GeneralizationIsInvalid
     * @throws Dimension\Exception\GeneralizationIsInvalid
     */
