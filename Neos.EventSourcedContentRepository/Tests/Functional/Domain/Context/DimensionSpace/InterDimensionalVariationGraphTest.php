...
namespace Neos\EventSourcedContentRepository\Tests\Functional\Domain\Context\DimensionSpace;
...
class InterDimensionalVariationGraphTest extends FunctionalTestCase
{
    ...
    /**
     * @test
     * @expectedException \Neos\EventSourcedContentRepository\Exception\DimensionSpacePointNotFound
