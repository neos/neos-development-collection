...
* ``image`` (TYPO3\Media\Domain\Model\ImageInterface, *optional*): The image to be rendered - DEPRECATED, use "asset" argument instead
...
* ``image`` (TYPO3\Media\Domain\Model\ImageInterface, *optional*): The image to be rendered - DEPRECATED, use "image" argument instead
